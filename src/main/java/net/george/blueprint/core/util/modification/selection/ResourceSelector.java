...
public interface ResourceSelector<S extends ResourceSelector<S>> {
    ...
    /**
     * Selects a list of {@link Identifier} instances from a {@link SelectionSpace} instance.
     *
     * @param space A {@link SelectionSpace} instance to select from.
     * @return A selected list of {@link Identifier} instances from a {@link SelectionSpace} instance.
     */
    List<Identifier> select(SelectionSpace space);
