...
/**
 * Similar to {@link ModelTransform} but includes additional fields for storing offset and scale values.
...
public final class EndimatorPartPose {
    public ModelTransform partPose = ModelTransform.NONE;
     ...
     *
     * @param partPose A {@link ModelTransform} instance to use.
     * @return This pose.
     */
    public EndimatorPartPose setPartPose(ModelTransform partPose) {
