 ...
 * <p>This class also has a {@link #read(NbtCompound)} and a {@link #write(NbtCompound)} to ease the serialization and deserialization of dynamic animations.</p>
 *
...
public final class TimedEndimation {
    ...
    public float getProgress(float partialTicks) {
        ...
        return MathHelper.clamp(tick / this.duration, 0.0F, 1.0F);
    }
    ...
    /**
     * Writes data about the animation to a given {@link NbtCompound}.
     *
     * @return The given {@link NbtCompound} with data about the animation.
     */
    ...
    /**
     * Reads data about the animation from a given {@link NbtCompound}.
     *
     * @param tag A {@link NbtCompound} to read from.
     */
