...
import net.george.blueprint.core.endimator.effects.ConfiguredEndimationEffect;
import net.george.blueprint.core.util.DataUtil;

import javax.annotation.Nonnull;
import java.util.*;

import static net.george.blueprint.common.codec.ErrorableOptionalFieldCodec.errorableOptional;
...
public final class Endimation {
    ...
    public static final Codec<Endimation> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
    ...
    public static final class PartKeyframes {
        ...
        public static final Codec<PartKeyframes> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
