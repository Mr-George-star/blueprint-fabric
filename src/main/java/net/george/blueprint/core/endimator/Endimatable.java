...
import net.george.blueprint.core.endimator.effects.EndimationEffectHandler;
import net.george.blueprint.core.endimator.effects.EndimationEffectSource;
import net.minecraft.entity.Entity;
import net.george.blueprint.core.endimator.effects.*;
import net.george.blueprint.core.mixin.EntityMixin;

/**
 * An interface representing an object that can process updates for {@link PlayableEndimation} instances.
 * <p>This gets mixin'd into {@link Entity}.</p>
 * <p>All methods in this interface are {@code default} because they have default behaviors or get mixin'd into {@link Entity}.</p>
 * <p>When implementing on classes not extending {@link Entity}, {@link #getEndimatedState()} must be overridden.</p>
 *
...
public interface Endimatable extends EndimationEffectSource {
     ...
     * <p><b>This must get overridden for implementations not extending {@link Entity}.</b></p>
     *
