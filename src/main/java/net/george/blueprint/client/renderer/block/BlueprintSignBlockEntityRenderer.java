...
public class BlueprintSignBlockEntityRenderer<T extends SignBlockEntity> implements BlockEntityRenderer<T> {
    ...
    private final Map<SignType, net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel> typeToModel;
    private final TextRenderer textRenderer;

    public BlueprintSignBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.typeToModel = SignType.stream().collect(ImmutableMap.toImmutableMap((signType) -> signType, (signType) ->
                new net.minecraft.client.render.block.entity.SignBlockEntityRenderer
                        .SignModel(ctx.getLayerModelPart(EntityModelLayers.createSign(signType)))));
    ...
    public void render(SignBlockEntity signBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel signModel = (net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel)this.typeToModel.get(signType);
        float h;
    ...
    public static net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel createSignModel(EntityModelLoader entityModelLoader, SignType type) {
        return new net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel(entityModelLoader.getModelPart(EntityModelLayers.createSign(type)));
    }
